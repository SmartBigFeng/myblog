var hongkong_proxy = 'PROXY openwrt.duqier.com:10809; DIRECT;';
var newyork_proxy = 'SOCKS5 server-03.duqier.com:8120; SOCKS server-03.duqier.com:8120;';
var rules = [
    [
        [],
        []
...
function FindProxyForURL(url, host) {
    ...
    //if (dnsDomainIs(host, "openai.com") || dnsDomainIs(host, "oaistatic.com")) {
    //    return newyork_proxy
    //}
    ...
    for (var i = 0; i < rules[index].length; i++) {
        for (var j = 0; j < rules[index][i].length; j++) {
            ...
            if (host == lastRule || host.endsWith('.' + lastRule))
                return i % 2 == 0 ? 'DIRECT' : hongkong_proxy;
        }
    }
    lastRule = '';
}
